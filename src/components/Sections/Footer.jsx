...
const Footer = () => {
  ...
  // Animate Gradient Line components
  ...
  return (
    <footer
      ref={footerRef}
      className={`relative ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-white text-shadow-gray-900'} overflow-hidden`}
    >
          ...
          <div className='max-w-6xl mx-auto'>
            ...
            >
              ...
              <motion.div variants={itemVariants} className=''>
                <motion.div
                  className='inline-flex items-center space-x-2 text-2xl font-medium cursor-pointer'
              ...
              >
                {socialLinks.map((social,index) => (
                  <motion.a
                    ...
                    className={`p-3 rounded-full transition-all duration-100 ${
                      isDarkMode? 
              ...
              <motion.div variants={itemVariants}>
                <motion.button
                  onClick={scrollToTop}
                  className={`inline-flex items-center space-x-2 px-4 py-2 rounded-full text-sm font-medium cursor-pointer transition-all duration-100 ${
                  ...
                  whileHover={{
                    y:-2,
                    scale: 1.05,
                    boxShadow: isDarkMode ? "0 10px 25px rgba(59,130,246,0.15)" 
