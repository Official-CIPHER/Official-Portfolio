...
import { EDUCATION, PASSIONS } from "../../utils/data.js";
          ...
          >
            ...
            >
              ...
              >
                ...
                solve real-worl problems. My passion lies in crafting digital
              ...
              >
                When I’m not coding, I’m exploring new frameworks and
                technologies, building side projects to sharpen my skills,
                studying the background and inner workings of each technology I
                learn, and experimenting with ideas that push my creativity.
              </p>
            </motion.div>
            ...
            <div className="space-y-8">
              {EDUCATION.map((step, index) => (
                ...
                >
                  {/* Timeline Dot */}
                  <div
                    className={`relative z-10 flex-shrink-0 w-16 h-16 rounded-full ${step.color} flex items-center
                justify-center group-hover:scale-110 transition-transform duration-100
                `}
                  >
                  ...
                  {/* Content */}
                  <div
                    className={`flex-grow p-6 rounded-xl border transition-all duration-75 ${
                      isDarkMode
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="text-xl font-medium">{step.degree}</h4>
                      <span
          ...
          >
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{scale:0.98}}
                className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-100"
              >
                Let's Work Together
              </motion.button>
            </motion.div>
