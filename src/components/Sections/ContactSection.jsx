...
const ContactSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://getform.io/f/arogollb", {
        method: "POST",
        headers: {
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            Ready to start your next? Let's discuss how we can bring your ideas
            to life.
          </motion.p>
        </motion.div>
                ...
                <div className="space-y-8">
                  ...
                  <motion.button
                    ...
                    className="w-full bg-blue-500 hover:bg-blue-600 disabled:bg-blue-400 
                      text-white py-4 rounded-xl text-sm uppercase tracking-wider font-medium 
                        transition-all duration-100 flex items-center justify-center space-x-2"
                  >
                    {isSubmitting ? (
                      <>
                        <motion.div
            ...
            >
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{scale:0.98}}
                  className={`px-6 py-3 rounded-full border font-medium transition-all duration-100 ${
